...
Usage:
  ...
  python tools/media/mix_music.py --bed ambient-pad --base video-1/output/video-1-first60-sfx.mp4 \
  ...
  python tools/media/mix_music.py --all --base video-1/output/video-1-first60-sfx.mp4
