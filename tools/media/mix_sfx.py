...
Usage:
  python tools/media/mix_sfx.py [video-1/work/sfx-plan.json]
  python tools/media/mix_sfx.py plan.json --print         # show the resolved cue sheet, no render
  python tools/media/mix_sfx.py plan.json --no-optional    # drop events marked "optional": true
  python tools/media/mix_sfx.py plan.json --no-duck --end 60 --out path.mp4
