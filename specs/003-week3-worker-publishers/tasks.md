...
- [x] T041 [Step8] Edit button sends "Reply with the new caption for post {id}:" and sets pending_edit flag (US7)
- [ ] T042 [Step8] Build message listener that reads reply and updates posts.caption (US7)
